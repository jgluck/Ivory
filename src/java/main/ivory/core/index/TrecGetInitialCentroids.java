 ...
 */
public class TrecGetInitialCentroids extends PowerTool {
  private static final Logger LOG = Logger.getLogger(TrecGetInitialCentroids.class);
  ...
  public TrecGetInitialCentroids(Configuration conf) {
    super(conf);
  }
  ...
  public int runTool() throws Exception {
    ...
    LOG.info("PowerTool: " + TrecGetInitialCentroids.class.getSimpleName());
    ...
    Job job = Job.getInstance(conf,
        TrecGetInitialCentroids.class.getSimpleName() + ":" + collectionName);
    job.setJarByClass(TrecGetInitialCentroids.class);
