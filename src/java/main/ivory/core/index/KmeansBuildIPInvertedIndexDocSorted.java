 ...
 */
public class KmeansBuildIPInvertedIndexDocSorted extends PowerTool {
  private static final Logger LOG = Logger.getLogger(KmeansBuildIPInvertedIndexDocSorted.class);
  ...
  public KmeansBuildIPInvertedIndexDocSorted(Configuration conf) {
    super(conf);
  }
  
  public KmeansBuildIPInvertedIndexDocSorted(Configuration conf,int i) {
    super(conf);
    this.pack = i;
  }
...
//    int collectionDocCnt = env.readCollectionDocumentCount();
    ...
    LOG.info("PowerTool: " + KmeansBuildIPInvertedIndexDocSorted.class.getSimpleName());
    ...
    Job job = Job.getInstance(conf,
        KmeansBuildIPInvertedIndexDocSorted.class.getSimpleName() + ":" + collectionName);
    job.setJarByClass(KmeansBuildIPInvertedIndexDocSorted.class);
