...
public class KmeansComputeGlobalTermStatistics extends PowerTool {
  private static final Logger LOG = Logger.getLogger(KmeansComputeGlobalTermStatistics.class);
  Integer pack = null;
  ...
  public int runTool() throws Exception {
    ...
    Job job = Job.getInstance(getConf(),
        KmeansComputeGlobalTermStatistics.class.getSimpleName() + ":" + collectionName);
    job.setJarByClass(KmeansComputeGlobalTermStatistics.class);
