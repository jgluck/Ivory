...
public class KmeansBuildDictionary extends PowerTool {
  private static final Logger LOG = Logger.getLogger(KmeansBuildDictionary.class);
  ...
  public KmeansBuildDictionary(Configuration conf) {
    super(conf);
  }
  ...
  public int runTool() throws Exception {
    ...
    LOG.info("PowerTool: " + KmeansBuildDictionary.class.getSimpleName());
    LOG.info(String.format(" - %s: %s", Constants.CollectionName, collectionName));
    LOG.info(String.format(" - %s: %s", Constants.CurrentPackNo, conf.getInt(Constants.CurrentPackNo, 0)));
    ...
    Job job = Job.getInstance(conf,
        KmeansBuildDictionary.class.getSimpleName() + ":" + collectionName);

    job.setJarByClass(KmeansBuildDictionary.class);
